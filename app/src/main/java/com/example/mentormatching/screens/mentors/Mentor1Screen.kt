...
@Composable
fun Mentor1Screen(navController: NavController) {
    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                Text(text = "Rio de Janeiro", color = Color.White, fontSize = 20.sp)
            }
                ...
                Row (
                    ...
                    Text(text = stringResource(id = R.string.civilEngineering), color = Color.White, fontSize = 20.sp)
                }
                Spacer(modifier = Modifier.height(8.dp))
                ...
                Row (
                    ...
                    Text(text = stringResource(id = R.string.academic), color = Color.White, fontSize = 20.sp)
                }
...
@Composable
fun PreviewMentor1Screen() {
    Mentor1Screen(navController = NavController(LocalContext.current))
}