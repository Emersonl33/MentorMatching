...
@Composable
fun Mentor3Screen(navController: NavController) {
    ...
    Box(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.menteef3),
            ...
            Column(
                ...
                Row (
                    ...
                    Text(text = stringResource(id = R.string.specialization), color = Color.White, fontSize = 20.sp)
                }
                Spacer(modifier = Modifier.height(8.dp))
                ...
                Row (
                    ...
                    Text(text = stringResource(id = R.string.administration), color = Color.White, fontSize = 20.sp)
                }
                Spacer(modifier = Modifier.height(8.dp))
                ...
                Row (
                    ...
                    Text(text = stringResource(id = R.string.entrepreneur), color = Color.White, fontSize = 20.sp)
                }
...
@Composable
fun PreviewMentor3Screen() {
    Mentor3Screen(navController = NavController(LocalContext.current))
}