...
@Composable
fun Mentor2Screen(navController: NavController) {
        ...
        Column(
            ...
            Column(
                ...
                Row (
                    ...
                    Text(text = stringResource(id = R.string.doctorateDegree), color = Color.White, fontSize = 20.sp)
                }
                Spacer(modifier = Modifier.height(8.dp))
...
@Composable
fun PreviewMentor2Screen() {
    Mentor2Screen(navController = NavController(LocalContext.current))
}